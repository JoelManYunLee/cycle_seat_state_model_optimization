function [Vcc] = better_simulate(f0M, resting_length_muscle, resting_length_tendon, alpha, norm_length)
    ...
    %%% TASK 2
        function velocity = get_muscle_velocity(alpha, norm_lm)
            ...
            muscle.resting_length_muscle = resting_length_muscle/1000;
            muscle.resting_length_tendon = resting_length_tendon/1000;
            muscle.f0M = f0M;
    
            muscle_tendon_length = resting_length_muscle/1000 + resting_length_tendon/1000;
